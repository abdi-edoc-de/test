        ...
        <div className="my-component">
            <div className="left-box">
                ...
                <div className="visa-text">
                    Electronic{" "}
                    <span className="green-text">Diversity visa</span> Entry
                    Form
                </div>
                ...
                <div className="line-and-text">
                    ...
                    <div className="lineText">
                        This is a full copy of the official DV Lottery
                        application form. Use it for training only. You will
                        need to apply on the official website
                        www.dvlottery.state.gov when it opens to take part in
                        the lottery.
                    </div>
                </div>
            </div>
